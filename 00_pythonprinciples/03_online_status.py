...
a dictionary that maps from strings of names to the string "online" or
...
def online_count(dictionary):
    ...
    online = len(list(filter(lambda value: value == "online", status)))
    print(online)
    return online


my_dic = {"Alice": "online", "Bob": "offline", "Eve": "online"}
